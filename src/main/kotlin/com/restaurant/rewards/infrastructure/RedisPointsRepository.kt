 ...
 */
class RedisPointsRepository : PointsRepository {

    override fun awardPoints(points: PointsAwarded) {
        TODO("Not yet implemented")
    }

    override fun getUserBalance(userId: UserId): Int {
        TODO("Not yet implemented")
    }

    override fun deductPoints(userId: UserId, points: Int) {
        TODO("Not yet implemented")
    }
}